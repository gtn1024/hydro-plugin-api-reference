...
[hydro-dev-skills](https://github.com/gtn1024/hydro-dev-skills) 是一组面向 AI 编程助手的 Hydro 插件开发 Skill，配合 [Skills](https://github.com/vercel-labs/skills) CLI 使用，可让 AI 快速掌握 Hydro 插件的编写模式。
